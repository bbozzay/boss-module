...
export default function(moduleOptions) {
  ...
  this.nuxt.hook('ready', async nuxt => {
    // console.log('Nuxt is ready', nuxt)
  })
  this.nuxt.hook('modules:done', moduleContainer => {
    // This will be called when all modules finished loading
    //console.log('all modules loaded', moduleContainer)
  })
  ...
  // Add Boss Plugin after Auth is loaded
  this.options.plugins.push(path.resolve(__dirname, './plugins/index.js'));
  ...
  for (const pathString of pluginsToSync) {
    ...
    console.log("add plugin", pathString)
    this.addPlugin({
